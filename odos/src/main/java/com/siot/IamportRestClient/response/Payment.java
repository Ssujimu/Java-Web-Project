...
public class Payment {
	...
	// started_at Date 변환 따로 추가한것
	public Date getStartedAtDate() {
		return new Date( started_at * 1000L );
	}
	...
	public String toString() {
		return "Payment [imp_uid=" + imp_uid + ", merchant_uid=" + merchant_uid + ", pay_method=" + pay_method
				+ ", channel=" + channel + ", pg_provider=" + pg_provider + ", emb_pg_provider=" + emb_pg_provider
				+ ", pg_tid=" + pg_tid + ", escrow=" + escrow + ", apply_num=" + apply_num + ", bank_code=" + bank_code
				+ ", bank_name=" + bank_name + ", card_code=" + card_code + ", card_name=" + card_name
				+ ", card_number=" + card_number + ", card_quota=" + card_quota + ", card_type=" + card_type
				+ ", vbank_code=" + vbank_code + ", vbank_name=" + vbank_name + ", vbank_num=" + vbank_num
				...
				+ ", custom_data=" + custom_data + ", status=" + status + ", started_at=" + started_at + ", paid_at="
				+ paid_at + ", failed_at=" + failed_at + ", cancelled_at=" + cancelled_at + ", fail_reason="
				+ fail_reason + ", cancel_reason=" + cancel_reason + ", receipt_url=" + receipt_url
				+ ", cancel_history=" + Arrays.toString(cancel_history) + ", cash_receipt_issued=" + cash_receipt_issued
				+ ", customer_uid=" + customer_uid + ", customer_uid_usage=" + customer_uid_usage + "]";
	}
}

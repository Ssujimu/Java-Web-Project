...
public class IamportClient {
	...
	public IamportResponse<PagedDataList<Payment>> paymentsByStatus(String status, int page, int limit, long from, long to, String sorting) throws IamportResponseException, IOException {
		AccessToken auth = getAuth().getResponse();
		Call<IamportResponse<PagedDataList<Payment>>> call = this.iamport.payments_by_status(auth.getToken(), status, page, limit, from, to, sorting);
